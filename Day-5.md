...
helped me move from simply using Git commands to understanding the workflow and mindset behind version control, which I expect will be valuable in future projects
---
...
It make the development workflow much smoother in the long run.
